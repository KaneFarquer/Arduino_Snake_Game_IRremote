...
void loop() {
  ...
  //Check For Inputs
if(recv.decode()){
    Serial.println(recv.decodedIRData.decodedRawData);
    //Check for next button
    if(recv.decodedIRData.decodedRawData ==2907897600 && snake.dir[1]==0){
    snake.dir[0] = 0;
    snake.dir[1] = -1;
   }else if(recv.decodedIRData.decodedRawData ==3877175040 && snake.dir[1]==0){
    snake.dir[0] = 0;
    snake.dir[1] = 1;
    }else if(recv.decodedIRData.decodedRawData ==4144561920 && snake.dir[0]==0){
    snake.dir[0] = -1;
    snake.dir[1] = 0;
   }else if(recv.decodedIRData.decodedRawData ==2774204160 && snake.dir[0]==0){
    snake.dir[0] = 1;
    snake.dir[1] = 0;
  }
  recv.resume();
